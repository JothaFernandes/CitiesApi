...
import com.github.jothaFernandes.citiesApi.cities.service.DistanceService;
import com.github.jothaFernandes.citiesApi.cities.service.EarthRadius;
...
public class DistanceResource {
    ...
    @GetMapping("/by-math")
    public ResponseEntity byMath(@RequestParam(name = "from") final Long city1, @RequestParam(name = "to") final Long city2, @RequestParam final EarthRadius unit){
      log.info("byMath");
