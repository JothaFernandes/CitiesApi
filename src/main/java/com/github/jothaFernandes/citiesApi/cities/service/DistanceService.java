package com.github.jothaFernandes.citiesApi.cities.service;
...
import com.github.jothaFernandes.citiesApi.utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceBypointsInMiles(final Long city1, final long city2) {
        log.info("nativePostegresInMiles({}, {})", city1, city2);
